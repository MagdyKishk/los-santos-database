...
import useWeedFarm from "../../zustand/bussinesses/mc/weedfarm";

export default function WeedFarm() {
    ...
    return (
        ...
        >
            ...
            {openSettings &&
                <WeedFarmSettings closeSettings={() => setOpenSettings(false)} />
            }
        </BussinessContainer>
    )
}

export function WeedFarmSettings({ closeSettings }: { closeSettings: () => void }) {
    const {
        supplies,
        currentValue,
        maxValue,
