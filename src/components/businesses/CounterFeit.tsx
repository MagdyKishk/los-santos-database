...
import useCounterFeit from "../../zustand/bussinesses/mc/counterfeit";
...
export default function CounterFeit() {
    ...
    return (
        ...
        >
            ...
            {openSettings &&
                <CounterFeitSettings closeSettings={() => setOpenSettings(false)} />
            }
        </BussinessContainer>
    )
}

export function CounterFeitSettings({ closeSettings }: { closeSettings: () => void }) {
    const {
        supplies,
        currentValue,
        maxValue,
