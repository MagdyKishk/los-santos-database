...
import useDocumentForgery from "../../zustand/bussinesses/mc/documentForgery";

export default function DocumentForgery() {
    ...
    return (
        ...
        >
            ...
            {openSettings &&
                <DocumentForgerySettings closeSettings={() => setOpenSettings(false)} />
            }
        </BussinessContainer>
    )
}

export function DocumentForgerySettings({ closeSettings }: { closeSettings: () => void }) {
    const {
        supplies,
        currentValue,
        maxValue,
